...
describe('StormGlass client', () => {
  ...
  const MockedRequestClass = HTTPUtil.Request as jest.Mocked<typeof HTTPUtil.Request>; //se refere a classe  não instância
  ...
  it('should return the normalized forecast the StormGlass service', async () => {
    ...
    mockedRequest.get.mockResolvedValue(
      { data: stormGlassWeather3horsFixture } as HTTPUtil.Response
      );
  ...
  it('should get an StormGlassResponseError when the StormGlass service responds with error', async () => {
    ...
    MockedRequestClass.isRequestError.mockReturnValue(true);//mocando erro de request
